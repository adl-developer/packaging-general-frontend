...
/**
 * Cart-shaped skeleton, shared by:
 *  - the /cart route loading state (loading.tsx), and
 *  - the instant overlay product-customizer shows while Add to Cart /
 *    Buy Now commits the line and navigates here.
 */
export function CartSkeleton() {
  return (
    <>
      <OrderProgress step={1} back={<Skeleton className="ml-3 h-5 w-36" />} />
